...
- Geographic scope:
  ...
  - selected city/metro case studies, with emphasis on Midwest and South locations where growth has recently accelerated.
- Suggested outputs:
  - long-run national trend lines (population, organization counts, orgs per 100,000),
  - city-level comparison panels for selected Midwest/South places,
...
6. shutdown: `run_pipeline_01_06_and_shutdown.sh` triggers machine shutdown after successful completion
